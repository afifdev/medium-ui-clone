...
export default function Navbar() {
  return (
    <div>
      <div className="flex justify-between items-center shadow-sm px-6 md:px-16 py-2 md:py-3.5 max-w-7xl mx-auto">
        <div className="flex justify-center gap-4 items-center">
          ...
          <div className="w-60 h-full hidden md:flex justify-center items-center">
            <Image
              src={LevelUp}
              quality={100}
              layout="intrinsic"
        ...
        <div className="text-sm flex justify-center items-center gap-8 text-green-700">
          ...
          <a className="block md:hidden">Open in app</a>
          <a className="px-4 py-2 rounded-full border border-green-700">
            Get Started
          </a>
        </div>
      </div>
      <div className="w-full shadow-md px-6">
        <div className="w-80 py-2 h-full flex md:hidden justify-center items-center">
          <Image
            src={LevelUp}
            quality={100}
            layout="intrinsic"
